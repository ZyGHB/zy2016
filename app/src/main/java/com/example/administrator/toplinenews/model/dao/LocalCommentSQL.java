 ...
 */
public class LocalCommentSQL extends SQLiteOpenHelper {
    //数据库的版本号
    public static final int DATABASE_VERSION = 1;
    //数据库名
    public static final String DATABASE_NAME = "local_comment.db";

    private static final String TAG = "LocalCommentSQL";

    private static final String TEXT_TYPE = " TEXT";
    private static final String COMMA_SEP = ",";


    public LocalCommentSQL(
            Context context,
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("CREATE TABLE " + NewsContract.LocalCommentEntry.TABLE_NAME +
                ...
                NewsContract.LocalCommentEntry.COLUMN_NAME_UID + TEXT_TYPE + COMMA_SEP +
                NewsContract.LocalCommentEntry.COLUMN_NAME_STAMP + TEXT_TYPE +
                ")"
        );
