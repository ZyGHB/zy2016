 ...
 */
public class CommentsAdapter extends MyBaseAdapter<Comments> {
    ...
    public View getMyView(int position, View convertView, ViewGroup parent) {
        ...
        Comments comment=myList.get(position);
    ...
    public class HoldView {
        ...
        public HoldView(View view) {
            iv_list_image = (ImageView) view.findViewById(R.id.iv_header_img);
